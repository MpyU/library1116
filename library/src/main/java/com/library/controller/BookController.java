...
public class BookController {
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "pageSize", value = "每页显示数量", required = true),
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "pageSize", value = "每页显示数量", required = true),
			@ApiImplicitParam(name = "currentPage", value = "当前页", required = true),
			@ApiImplicitParam(name = "id", value = "书的ID"), @ApiImplicitParam(name = "bookName", value = "书名"),
			@ApiImplicitParam(name = "searchId", value = "检索号"), @ApiImplicitParam(name = "cardId", value = "书的编号"),
	...
	public Result<PageInfo<Book>> selectAllByCondition(@PathVariable("pageSize") Integer pageSize,
			@PathVariable("currentPage") Integer currentPage, Book book) {
		if (pageSize == null) {
			pageSize = 5;
		}
		if (currentPage == null) {
	...
	@ApiOperation("新增书籍")
	@ApiImplicitParams({ @ApiImplicitParam(name = "bookName", value = "书名", defaultValue = "西游记"),
	...
	@ApiOperation("修改书籍信息")
	@ApiImplicitParams({ @ApiImplicitParam(name = "id", value = "书ID", defaultValue = "1"),
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "id", value = "书的ID", defaultValue = "1"), })
