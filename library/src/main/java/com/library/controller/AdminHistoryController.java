...
public class AdminHistoryController {
	...
	public Result<PageInfo<UserBook>> historyByUserId(@PathVariable("userId") Integer userId,
	...
	public Result<PageInfo<UserBook>> historyByUserBookName(@RequestParam("bookName") String bookName,
			@PathVariable("pageSize") Integer pageSize, @PathVariable("currentPage") Integer currentPage) {
